...
$(()=>{require("./map.js"),require("./chit.js"),require("./characterData.js"),require("./mapMask.js"),require("./mapMarker.js"),require("./memo.js"),require("./magicRange.js")});

},{"./characterData.js":19,"./chit.js":20,"./magicRange.js":21,"./map.js":22,"./mapMarker.js":23,"./mapMask.js":24,"./memo.js":25}],19:[function(require,module,exports){
...
$(()=>{require("./version.js"),require("./loginCheck.js"),require("./roomDelete.js"),require("./saveChatLog.js"),require("./loadSaveData.js"),require("./chatPalette.js"),require("./graveyard.js"),require("./addCharacter.js"),require("./magicRangeMarker.js"),require("./magicRangeDD4th.js"),require("./magicRangeLH.js"),require("./magicRangeMG.js"),require("./chit.js"),require("./mapMask.js"),require("./mapMarker.js"),require("./mapChange.js"),require("./upload.js"),require("./imageDelete.js"),require("./playRoomInfo.js"),require("./memo.js"),require("./initiative.js"),require("./chat.js"),require("./help.js"),require("./chatFont.js"),require("./characterCutin.js")});

},{"./addCharacter.js":30,"./characterCutin.js":31,"./chat.js":32,"./chatFont.js":33,"./chatPalette.js":34,"./chit.js":35,"./graveyard.js":36,"./help.js":37,"./imageDelete.js":38,"./initiative.js":39,"./loadSaveData.js":40,"./loginCheck.js":41,"./magicRangeDD4th.js":42,"./magicRangeLH.js":43,"./magicRangeMG.js":44,"./magicRangeMarker.js":45,"./mapChange.js":46,"./mapMarker.js":47,"./mapMask.js":48,"./memo.js":49,"./playRoomInfo.js":50,"./roomDelete.js":51,"./saveChatLog.js":52,"./upload.js":53,"./version.js":54}],30:[function(require,module,exports){
...
},{"../.option.spectrum.json":17}],34:[function(require,module,exports){
(function (Buffer){
...
},{"../.option.spectrum.json":17,"buffer":2}],35:[function(require,module,exports){
function chit_show(t){$("#window_chit").show().css("zIndex",151),$(".draggable:not(#window_chit)").css("zIndex",150);var i;index=0,reg=/^(\d+)$/;for(item in ddf.characters)(v=reg.exec(ddf.characters[item].data.name))&&(index=Math.max(index,parseInt(v[1])));i={type:"chit",name:index+1,width:1,height:1,color:0,imgId:"",isPaint:!1,draggable:!0,rotation:0,message:"",x:0,y:0},$("#chit_imgId").val(i.imgId),$("#chit_width").val(i.width),$("#chit_height").val(i.height),$("#chit_info").val(i.info),$("#chit_imageUrl").val(i.imageUrl),chit_previewUpdate()}function chit_previewUpdate(){zoom=Math.min(1,4.6/$("#chit_width").val(),4.8/$("#chit_height").val()),$("#chit_preview").css("transform",`scale(${zoom})`),$("#chit_preview").css({width:50*$("#chit_width").val(),height:50*$("#chit_height").val(),backgroundImage:"url("+ddf.base_url+$("#chit_imageUrl").val()+")"})}$("#btn_createchit").on("click",t=>{chit_show("")}),$("#window_chit input").on("change",chit_previewUpdate),ddf.cmd.chit_show=chit_show,$("#chit_close, #chit_close2").on("click",t=>{$("#window_chit").hide()});var click={x:0,y:0};$("#chit_preview").draggable({start:t=>{click.x=t.clientX,click.y=t.clientY},helper:()=>{let t=$("#chit_preview").clone();return t.appendTo("#mapSurface"),t},drag:(t,i)=>{var e=ddf.roomState.zoom,o=i.originalPosition;i.position={left:(t.clientX-click.x+o.left)/e,top:(t.clientY-click.y+o.top)/e},ddf.roomState.viewStateInfo.isSnapMovablePiece&&(ddf.roomState.mapData.isAlternately&&ddf.roomState.mapData.gridInterval%2==1?1&Math.floor(i.position.top/50/ddf.roomState.mapData.gridInterval)?i.position={left:25*(1^(1|Math.floor(i.position.left/25))),top:50*Math.floor(i.position.top/50)}:i.position={left:25*(1|Math.floor(i.position.left/25)),top:50*Math.floor(i.position.top/50)}:i.position={left:50*Math.floor(i.position.left/50),top:50*Math.floor(i.position.top/50)})},stop:(t,i)=>{character={type:"chit",width:$("#chit_width").val(),height:$("#chit_height").val(),info:$("#chit_info").val(),isPaint:$("#chit_isPaint").prop("checked"),imageUrl:$("#chit_imageUrl").val(),imgId:"",draggable:!$("#chit_draggable").prop("checked"),rotation:0,x:i.position.left/50,y:i.position.top/50},ddf.addCharacter(character),$("#window_chit").hide()}});
