...
function setZoom(t,e=!0){e?ddf.roomState.zoom+=t:ddf.roomState.zoom=t,ddf.roomState.zoom<.1&&(ddf.roomState.zoom=.1),ddf.roomState.zoom>3&&(ddf.roomState.zoom=3),$("#map").css("transform","scale("+ddf.roomState.zoom+")")}$(()=>{$("#btn_save").on("click",t=>{}),$("#btn_load").on("click",t=>{}),$("#btn_saveall").on("click",t=>{}),$("#btn_loadall").on("click",t=>{}),$("#btn_startrecord").on("click",t=>{}),$("#btn_endrecord").on("click",t=>{}),$("#btn_cancelrecord").on("click",t=>{}),$("#btn_logout, #btn_logout2").on("click",t=>{ddf.logout().then(t=>{ddf.userState.room=-1,location.href="index.html"})}),$("#btn_displaychat").on("click",t=>{ddf.roomState.viewStateInfo.isChatVisible=!ddf.roomState.viewStateInfo.isChatVisible,$(t.currentTarget).toggleClass("checked"),$("#window_chat .inner").toggle()}),$("#btn_displaydice").on("click",t=>{ddf.roomState.viewStateInfo.isDiceVisible=!ddf.roomState.viewStateInfo.isDiceVisible,$(t.currentTarget).toggleClass("checked"),$("#diceResult").toggle()}),$("#btn_displayinitiative").on("click",t=>{ddf.roomState.viewStateInfo.isInitiativeListVisible=!ddf.roomState.viewStateInfo.isInitiativeListVisible,$(t.currentTarget).toggleClass("checked"),$("#initiative").toggle()}),$("#btn_displayresource").on("click",t=>{ddf.roomState.viewStateInfo.isResourceWindowVisible=!ddf.roomState.viewStateInfo.isResourceWindowVisible,$(t.currentTarget).toggleClass("checked")}),$("#btn_displaychatpalette").on("click",t=>{ddf.roomState.viewStateInfo.isChatPaletteVisible=!ddf.roomState.viewStateInfo.isChatPaletteVisible,$(t.currentTarget).toggleClass("checked")}),$("#btn_displaycounter").on("click",t=>{ddf.roomState.viewStateInfo.isCounterRemoconVisible=!ddf.roomState.viewStateInfo.isCounterRemoconVisible,$(t.currentTarget).toggleClass("checked")}),$("#btn_displaycharacter").on("click",t=>{ddf.roomState.viewStateInfo.isCutInVisible=!ddf.roomState.viewStateInfo.isCutInVisible,$(t.currentTarget).toggleClass("checked"),$("#characterCutIn").toggle()}),$("#btn_displaycutin").on("click",t=>{ddf.roomState.viewStateInfo.isStandingGraphicVisible=!ddf.roomState.viewStateInfo.isStandingGraphicVisible,$(t.currentTarget).toggleClass("checked")}),$("#btn_displaygridnum").on("click",t=>{ddf.roomState.viewStateInfo.isPositionVisible=!ddf.roomState.viewStateInfo.isPositionVisible,$(t.currentTarget).toggleClass("checked"),ddf.cmd.refresh_parseMapData({mapData:ddf.roomState.mapData})}),$("#btn_displaygridline").on("click",t=>{ddf.roomState.viewStateInfo.isGridVisible=!ddf.roomState.viewStateInfo.isGridVisible,$(t.currentTarget).toggleClass("checked"),ddf.cmd.refresh_parseMapData({mapData:ddf.roomState.mapData})}),$("#btn_gridguide").on("click",t=>{ddf.roomState.viewStateInfo.isSnapMovablePiece=!ddf.roomState.viewStateInfo.isSnapMovablePiece,$(t.currentTarget).toggleClass("checked")}),$("#btn_adjustcharacter").on("click",t=>{ddf.roomState.viewStateInfo.isAdjustImageSize=!ddf.roomState.viewStateInfo.isAdjustImageSize,$(t.currentTarget).toggleClass("checked"),$("#characterCutIn").toggleClass("adjust")}),$("#btn_chatfont").on("click",t=>{}),$("#btn_resetwindow").on("click",t=>{}),$("#btn_resetdisplay").on("click",t=>{}),$("#btn_ragedd3").on("click",t=>{}),$("#btn_rangelh").on("click",t=>{}),$("#btn_rangemg").on("click",t=>{}),$("#btn_magictimer").on("click",t=>{}),$("#btn_createchit").on("click",t=>{}),$("#btn_waitroom").on("click",t=>{}),$("#btn_rotate").on("click",t=>{ddf.roomState.viewStateInfo.isRotateMarkerVisible=!ddf.roomState.viewStateInfo.isRotateMarkerVisible,$(t.currentTarget).toggleClass("checked")}),$("#btn_cardpickup").on("click",t=>{ddf.roomState.viewStateInfo.isCardPickUpVisible=!ddf.roomState.viewStateInfo.isCardPickUpVisible,$(t.currentTarget).toggleClass("checked")}),$("#btn_cardlog").on("click",t=>{ddf.roomState.viewStateInfo.isCardHandleLogVisible=!ddf.roomState.viewStateInfo.isCardHandleLogVisible,$(t.currentTarget).toggleClass("checked")}),$("#btn_cardchange").on("click",t=>{}),$("#btn_cardreset").on("click",t=>{}),$("#btn_maptile").on("click",t=>{}),$("#btn_mapmodify").on("click",t=>{}),$("#btn_mapsave").on("click",t=>{ddf.saveMap().then(t=>{"OK"==t.result&&(a=$(`<a href="${ddf.base_url+t.saveFileName.replace("./","")}" download="">.</a>`),$(document.body).append(a),a[0].click(),a[0].remove())})}),$("#btn_mapchange").on("click",t=>{}),$("#btn_camera").on("click",t=>{}),$("#btn_imagetagedit").on("click",t=>{});var t=require("../../package.json").version;$("#btn_version2").on("click",e=>{$("#version_DodontoF").text(ddf.info.version),$("#version_ddfjs").text(ddf.version),$("#version_ddfcli").text(t),$("#window_version").show().css("zIndex",151),$(".draggable:not(#window_version)").css("zIndex",150)}),$("#btn_manual2").on("click",t=>{window.open(ddf.base_url+"README.html")}),$("#btn_tutorial").on("click",t=>{}),$("#btn_site2").on("click",t=>{window.open("http://www.dodontof.com/")}),$("#btn_zoomin").on("click",()=>{setZoom(.1)}),$("#btn_zoomout").on("click",()=>{setZoom(-.1)}),$("#btn_screenshot").on("click",generate)});
